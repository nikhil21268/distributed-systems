...
class RaftNode(raft_pb2_grpc.RaftServiceServicer):
    ...
    def RequestVote(self, request, context):
        ...
        return raft_pb2.RequestVoteReply(term=response["term"], vote_granted=response["vote_granted"], lease_duration=response["lease_duration"])
    ...
    def request_vote_rpc(self, term, candidate_id, last_log_index, last_log_term):
        ...
        if term < self.term:
            return {
                "term": self.term,
                "vote_granted": False,
                "lease_duration": self.leader_lease_remaining_time
            }
...
server nodes:
python3 final_code_S1.py --node_id 0 --node_ip 10.128.0.3 --node_port 60000
python3 final_code_S1.py --node_id 1 --node_ip 10.128.0.4 --node_port 60001
python3 final_code_S1.py --node_id 2 --node_ip 10.128.0.5 --node_port 60002
python3 final_code_S1.py --node_id 3 --node_ip 10.128.0.6 --node_port 60003
python3 final_code_S1.py --node_id 4 --node_ip 10.128.0.7 --node_port 60004
.
.
